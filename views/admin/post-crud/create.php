<div class="row">
    ...
    if (isset($simpan)) {
        ...
        if ($file != "") {
            if (move_uploaded_file($file_temp, $folder . $file)) {
                ...
                insert($table = "tb_cerpen", $data_post);
    ...
    <div class="col-lg-6">
        <h3 class="mb-3 mt-3">Tambah Cerpen</h3>
        ...
        <form action="" method="post" class="form-post" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="penulis" required placeholder="Nama Penulis">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" name="cover" accept="image/*" id="" placeholder=""
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" required name="excerpt" id="" rows="3"></textarea>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="x" class="form-control d-none" name="isi" required placeholder="Isi cerpen">
                <div class="invalid-feedback">
                    Tuliskan isi cerpen
                </div>
